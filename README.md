...
- **[matplotlib](https://github.com/matplotlib/matplotlib):** fixed `PercentFormatter` crashing when used with an explicit `decimals` and no attached axis (shipping in milestone `v3.12.0`) ([#31995](https://github.com/matplotlib/matplotlib/pull/31995))
- **[fsspec](https://github.com/fsspec/filesystem_spec):** made `MemoryFileSystem` create the file when appending to a missing path, matching builtin `open()` and `LocalFileSystem` ([#2062](https://github.com/fsspec/filesystem_spec/pull/2062))
- **[accelerate](https://github.com/huggingface/accelerate):** fixed duplicated words in user-facing messages ([#4091](https://github.com/huggingface/accelerate/pull/4091))
